...
def initialize(context):
    ...
    context.change = 0
    context.agent = Q_Learner(context.discount, context.alpha)
...
def mainFunction(context, data):
    ...
    # In the case of epsilon we want a different action than the Tabular Q-Learning one
